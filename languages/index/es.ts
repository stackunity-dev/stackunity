export default {
  meta: {
    title: "StackUnity - Simplifica tu flujo de desarrollo",
    description: "StackUnity es la plataforma todo en uno para desarrolladores que quieren simplificar su flujo de trabajo y desarrollar más rápido.",
    keywords: "desarrollo web, plataforma de desarrolladores, herramientas de desarrollo, auditoría SEO, generador SQL, accesibilidad",
  },
  hero: {
    tagline: "OPTIMIZE YOUR WORKFLOW",
    title: "Simplifica tu flujo de desarrollo con unos pocos clics y desarrolla más rápido",
    description: "Desarrolla más rápido y simplifica tu flujo de trabajo con nuestras herramientas profesionales integradas. Construye, gestiona y optimiza tus proyectos para un sitio más accesible, fácil de usar y optimizado para SEO.",
    features: ["Gestión de sitios web", "Auditoría de sitios", "Accesibilidad", "Pruebas de API"],
    cta: "Simplifica tu flujo de trabajo ahora",
    ctaMobile: "Prueba gratis"
  },
  stats: {
    accelerated: "Desarrollo acelerado",
  ...
  features: {
    ...
    semantic: {
      title: "Semántica",
      description: "Optimiza tu sitio web con nuestras herramientas de análisis semántico y ARIA."
    },
    apiTesting: {
  ...
  howItWorks: {
    title: "Cómo funciona",
    description: "Tres simples pasos para transformar tu flujo de desarrollo",
    steps: [
      {
        title: "Crea tu cuenta",
        description: "Regístrate gratis y configura tu perfil de desarrollador en pocos minutos."
      },
      {
        title: "Elige tus herramientas",
        description: "Selecciona las herramientas que necesitas para tu proyecto de nuestra amplia gama de características."
      },
      {
        title: "Desarrolla más rápido",
        description: "Usa nuestras herramientas para acelerar tu desarrollo y mejorar la calidad de tus proyectos."
      }
    ]
  },
  cta: {
    title: "¿Listo para empezar?",
    description: "Simplifica tu flujo de trabajo con nuestras herramientas y descansa más ahora.",
    button: "Prueba gratuita de 7 días",
  ...
  footer: {
    ...
    newsletter: {
      ...
      button: "Suscribirse",
      description: "Recibe nuestras últimas noticias y consejos de desarrollo"
    },
