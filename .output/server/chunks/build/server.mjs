import { defineComponent as defineComponent$1, capitalize, h, camelize, inject as inject$1, computed, provide, isRef, ref, readonly, unref, toRef, shallowRef, watch, nextTick, toRefs, TransitionGroup, Transition, mergeProps, resolveDynamicComponent, reactive, createVNode, Fragment, getCurrentInstance as getCurrentInstance$1, warn, watchEffect, isVNode, Comment, hasInjectionContext, onScopeDispose, markRaw, Suspense, toRaw, shallowReactive, effectScope, version as version$1, defineAsyncComponent, useSSRContext, Text, withDirectives, resolveDirective, Teleport, vShow, createApp, withCtx, createTextVNode, toDisplayString, createBlock, openBlock, renderList, createCommentVNode, onErrorCaptured, onServerPrefetch, isReadonly, isShallow, isReactive, getCurrentScope } from 'vue';
import { E as hasProtocol, F as isScriptProtocol, G as joinURL, H as withQuery, I as sanitizeStatusCode, J as getContext, $ as $fetch$1, K as createHooks, e as createError$1, L as toRouteMatcher, M as createRouter$1, N as defu, d as destr, O as klona, P as parse, q as getRequestHeader, Q as isEqual$1, i as setCookie, l as getCookie, m as deleteCookie } from '../_/nitro.mjs';
import { b as baseURL } from '../routes/renderer.mjs';
import { defineStore, createPinia, setActivePinia, shouldHydrate } from 'pinia';
import { getActiveHead, CapoPlugin } from 'unhead';
import { defineHeadPlugin } from '@unhead/shared';
import { RouterView, useRoute as useRoute$2, useRouter as useRouter$2, createMemoryHistory, createRouter, START_LOCATION } from 'vue-router';
...
const _routes = [
  {
    ...
    component: () => import('./about-BUpf9lnP.mjs')
  },
  {
    name: "accessibility",
    path: "/accessibility",
    meta: __nuxt_page_meta$j || {},
    component: () => import('./accessibility-B0jVZkpV.mjs')
  },
  {
    name: "admin-analytics",
    path: "/admin/analytics",
    meta: __nuxt_page_meta$i || {},
    component: () => import('./analytics-ownNWRfB.mjs')
  },
  {
    name: "admin-newsletter-admin",
    path: "/admin/newsletter-admin",
    meta: __nuxt_page_meta$h || {},
    component: () => import('./newsletter-admin-FPNMxKeb.mjs')
  },
  {
    name: "checkout",
    path: "/checkout",
    meta: __nuxt_page_meta$g || {},
    component: () => import('./checkout-EWh16_Sz.mjs')
  },
  {
    name: "contact",
    path: "/contact",
    meta: __nuxt_page_meta$f || {},
    component: () => import('./contact-DqL6SLP7.mjs')
  },
  {
    name: "cookies",
    path: "/cookies",
    meta: __nuxt_page_meta$e || {},
    component: () => import('./cookies-BQsVW1ws.mjs')
  },
  {
    name: "dashboard",
    path: "/dashboard",
    meta: __nuxt_page_meta$d || {},
    component: () => import('./dashboard-Bu-quE_m.mjs')
  },
  {
    name: "index",
    path: "/",
    meta: __nuxt_page_meta$c || {},
    component: () => import('./index-BbixtibD.mjs')
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta$b || {},
    component: () => import('./login-BoVhwAza.mjs')
  },
  {
    name: "privacy",
    path: "/privacy",
    meta: __nuxt_page_meta$a || {},
    component: () => import('./privacy-BQsLycpV.mjs')
  },
  {
    name: "responsive",
    path: "/responsive",
    meta: __nuxt_page_meta$9 || {},
    component: () => import('./responsive-AQclKe4D.mjs')
  },
  {
    name: "robots",
    path: "/robots",
    meta: __nuxt_page_meta$8 || {},
    component: () => import('./robots-D7-apDVo.mjs')
  },
  {
    name: "seo-audit",
    path: "/seo-audit",
    meta: __nuxt_page_meta$7 || {},
    component: () => import('./seo-audit-C_lK1OIw.mjs')
  },
  {
    name: "settings",
    path: "/settings",
    meta: __nuxt_page_meta$6 || {},
    component: () => import('./settings-nYSINPPv.mjs')
  },
  {
    name: "signup",
    path: "/signup",
    meta: __nuxt_page_meta$5 || {},
    component: () => import('./signup-BOtbYqne.mjs')
  },
  {
    name: "snippets",
    path: "/snippets",
    meta: __nuxt_page_meta$4 || {},
    component: () => import('./snippets-Dcea33OG.mjs')
  },
  {
    name: "snippetsView",
    path: "/snippetsView",
    meta: __nuxt_page_meta$3 || {},
    component: () => import('./snippetsView-B91H7Ts1.mjs')
  },
  {
    name: "sql-generator",
    path: "/sql-generator",
    meta: __nuxt_page_meta$2 || {},
    component: () => import('./sql-generator-sNVPv6fg.mjs')
  },
  {
    name: "studio",
    path: "/studio",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./studio-vvHSXKSV.mjs')
  },
  {
    name: "subscription",
    path: "/subscription",
    component: () => import('./subscription-BM_mSg1U.mjs')
  },
  {
    name: "terms",
    path: "/terms",
    component: () => import('./terms-lNzvusTy.mjs')
  },
  {
    name: "unsubscribe",
    path: "/unsubscribe",
    meta: __nuxt_page_meta || {},
    component: () => import('./unsubscribe-DkrxYLCP.mjs')
  }
];
...
const namedMiddleware = {
  premium: () => import('./premium-ChaJQzMv.mjs')
};
  ...
  actions: {
    ...
    async logout() {
      try {
        await fetch("/api/auth/logout", {
          method: "POST",
          credentials: "include"
          // Important pour envoyer le cookie HttpOnly
        });
        this.user = null;
    ...
    persistUserData() {
      ...
      try {
        const userData = {
          user: {
            id: ((_a = this.user) == null ? void 0 : _a.id) || 0,
            username: ((_b = this.user) == null ? void 0 : _b.username) || "",
            email: ((_c = this.user) == null ? void 0 : _c.email) || "",
            isAdmin: ((_d = this.user) == null ? void 0 : _d.isAdmin) || false,
            isPremium: ((_e = this.user) == null ? void 0 : _e.isPremium) || false
          },
    ...
    async login(email, password) {
      try {
        const response = await fetch("/api/auth/login", {
          ...
          credentials: "include"
          // Important pour recevoir le cookie HttpOnly
        });
        if (!response.ok) {
    ...
    async updateUser(email, username, company, website, bio) {
      try {
    ...
    async signUp(username, email, password) {
      try {
        const response = await fetch("/api/auth/signup", {
          ...
          credentials: "include"
          // Important pour recevoir les cookies HttpOnly
        });
        if (!response.ok) {
    ...
    async saveSQLSchema(databaseName, tables) {
      try {
        const schemaData = {
        ...
        const response = await $fetch("/api/sql/saveSQLSchema", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${this.token}`
    ...
    async loadData() {
      try {
        ...
        this.user = {
          id: (userData == null ? void 0 : userData.id) || 0,
          username: (userData == null ? void 0 : userData.username) || "",
          email: (userData == null ? void 0 : userData.email) || "",
          isAdmin: Boolean(userData == null ? void 0 : userData.isAdmin),
          isPremium: Boolean(userData == null ? void 0 : userData.isPremium),
          company: (userData == null ? void 0 : userData.company) || "",
          website: (userData == null ? void 0 : userData.website) || "",
          bio: (userData == null ? void 0 : userData.bio) || ""
        };
    ...
    async addSnippets(title, description, framework, file, publishWorld, publishPersonal) {
      var _a;
      try {
        const username = ((_a = this.user) == null ? void 0 : _a.username) || "";
        ...
        const response = await $fetch("/api/snippets/addSnippets", {
          ...
          body: { username, date: date2, title, description, framework, img: imageUrl, publishWorld, publishPersonal }
        });
    ...
    async updateSnippet(id, code, type) {
      try {
    ...
    async deleteSQLSchema(databaseId) {
      try {
        const response = await $fetch(`/api/sql/${databaseId}`, {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${this.token}`
          }
    ...
    async saveTemplate(templateName, templateData, componentType) {
      try {
    ...
    async addNewsletter(newsletterName) {
      try {
    ...
    async addFavorite(snippetId, type) {
      try {
    ...
    async removeFavorite(snippetId) {
      try {
    ...
    async forgotPassword(email) {
      ...
      try {
        ...
        throw new Error(((_a = error.data) == null ? void 0 : _a.message) || "Erreur lors de la réinitialisation du mot de passe");
      }
    },
    ...
    async checkout(cardholderName, countryCode = "FR") {
      const currency = "eur";
      try {
        ...
        if (response && typeof response === "object" && "success" in response) {
          if (response.success && "clientSecret" in response) {
            const taxDetails = "taxDetails" in response ? response.taxDetails : void 0;
            return {
              success: true,
        ...
        return {
          success: false,
          error: response && typeof response === "object" && "error" in response ? response.error : "Invalid server response"
        };
      } catch (error) {
...
const useCookieStore = defineStore("cookie", {
  ...
  actions: {
    ...
    setCookie(name, value, expiryDays = 30, options = {}) {
      return;
    },
    getCookie(name) {
      return null;
    },
    async sendCookieDataToServer(type, data) {
      return;
    },
    debugCookieState() {
      return;
...
const cookies_rCS2psPm8j = /* @__PURE__ */ defineNuxtPlugin({
  name: "cookies-plugin",
  enforce: "pre",
  setup(nuxtApp) {
    if (nuxtApp.$pinia) {
...
const plugin_MxSTHTxbqc = /* @__PURE__ */ defineNuxtPlugin({
  name: "pinia-plugin-persistedstate",
  setup({ $pinia }) {
    $pinia.use(piniaPlugin);
  }
});
const api_interceptor_xko3o2jbnJ = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  useUserStore();
});
const auth_vT9JWWT9pN = /* @__PURE__ */ defineNuxtPlugin(async (nuxtApp) => {
  useUserStore();
  useRouter$1();
});
const token_NCWuir2H2e = /* @__PURE__ */ defineNuxtPlugin(async (nuxtApp) => {
  ...
  nuxtApp.hook("app:error", async (error) => {
    if ((error == null ? void 0 : error.statusCode) === 401 && userStore.isAuthenticated) {
      ...
      if (refreshed) {
        ...
        const currentPath = (void 0).location.pathname;
...
const plugins = [
  ...
  plugin_MxSTHTxbqc,
  api_interceptor_xko3o2jbnJ,
  auth_vT9JWWT9pN,
  token_NCWuir2H2e,
  vuetify_7h9QAQEssH
];
const layouts = {
  dashboard: defineAsyncComponent(() => import('./dashboard-Csk7zY5o.mjs').then((m) => m.default || m)),
  default: defineAsyncComponent(() => import('./default-CtVETMuE.mjs').then((m) => m.default || m)),
  empty: defineAsyncComponent(() => import('./empty-D5uVCGCK.mjs').then((m) => m.default || m)),
  landing: defineAsyncComponent(() => import('./landing-ieDsAX1K.mjs').then((m) => m.default || m))
};
...
_sfc_main$5.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/analytics/DataCollector.vue");
  return _sfc_setup$5 ? _sfc_setup$5(props, ctx) : void 0;
};
const AnalyticsDataCollector = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-fa9e3cf9"]]);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(VDialog, mergeProps({
        ...
        "onUpdate:modelValue": ($event) => showSettings.value = $event,
        width: "500"
      }, _attrs), {
          ...
          if (_push2) {
            _push2(ssrRenderComponent(VCard, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(VCardTitle, { class: "text-h5 pb-2" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(` Cookie preferences `);
                      } else {
                        return [
                  ...
                  _push3(ssrRenderComponent(VCardSubtitle, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(` Customize your cookie preferences `);
                      } else {
                        return [
                      ...
                      if (_push4) {
                        _push4(ssrRenderComponent(VList, null, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<!--[-->`);
                              ssrRenderList(cookieOptions, (cookie, key) => {
                                _push5(`<!--[-->`);
                                _push5(ssrRenderComponent(VListItem, null, {
                                  default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                        ...
                                        default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                          if (_push7) {
                                            _push7(ssrRenderComponent(VSwitch, {
                                              modelValue: cookiePreferences.value[key],
                                              "onUpdate:modelValue": ($event) => cookiePreferences.value[key] = $event,
                                              label: cookie.label,
                                              color: "primary",
                                      ...
                                      _push6(ssrRenderComponent(VListItemSubtitle, { class: "text-caption mt-1" }, {
                                        default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                          if (_push7) {
                                            _push7(`${ssrInterpolate(cookie.description)}`);
                                          } else {
                                            return [
                                              createTextVNode(toDisplayString(cookie.description), 1)
                                            ];
                                          }
                                        }),
                                        _: 2
                              ...
                              return [
                                (openBlock(), createBlock(Fragment, null, renderList(cookieOptions, (cookie, key) => {
                                  return openBlock(), createBlock(Fragment, { key }, [
                                    ...
                                    key !== "marketing" ? (openBlock(), createBlock(VDivider, {
                                      key: 0,
                                      class: "my-2"
...
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/cookieOptions.vue");
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent$1({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (!unref(cookieStore).hasGivenConsent) {
        _push(`<div${ssrRenderAttrs(_attrs)} data-v-8bdccf7e>`);
        _push(ssrRenderComponent(VSnackbar, {
          modelValue: showBanner.value,
          "onUpdate:modelValue": ($event) => showBanner.value = $event,
          timeout: -1,
          location: "bottom",
          class: "cookie-banner",
          elevation: "4",
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="d-flex flex-column" data-v-8bdccf7e${_scopeId}><div class="text-subtitle-1 font-weight-bold mb-2" data-v-8bdccf7e${_scopeId}> Cookie consent </div><div class="mb-4" data-v-8bdccf7e${_scopeId}> We use cookies to improve your experience, personalize content, and analyze our traffic. You can choose to accept all cookies or customize them. </div><div class="d-flex flex-wrap align-center justify-space-between" data-v-8bdccf7e${_scopeId}><div data-v-8bdccf7e${_scopeId}>`);
              ...
              return [
                createVNode("div", { class: "d-flex flex-column" }, [
                  createVNode("div", { class: "text-subtitle-1 font-weight-bold mb-2" }, " Cookie consent "),
                  createVNode("div", { class: "mb-4" }, " We use cookies to improve your experience, personalize content, and analyze our traffic. You can choose to accept all cookies or customize them. "),
                  createVNode("div", { class: "d-flex flex-wrap align-center justify-space-between" }, [
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/cookie-banner.vue");
  return _sfc_setup$3 ? _sfc_setup$3(props, ctx) : void 0;
};
const CookieBanner = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-8bdccf7e"]]);
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent$1({
  ...
  setup(__props) {
    ...
    onErrorCaptured((err, instance, info) => {
      if (err instanceof TypeError && (err.message.includes("'parentNode'") || err.message.includes("'type' of 'vnode' as it is null"))) {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  if (unref(cookieStore).preferences.analytics) {
                    _push3(ssrRenderComponent(AnalyticsDataCollector, null, null, _parent3, _scopeId2));
                  } else {
                    _push3(`<!---->`);
                  }
                } else {
                  return [
                    ...
                    unref(cookieStore).preferences.analytics ? (openBlock(), createBlock(AnalyticsDataCollector, { key: 0 })) : createCommentVNode("", true)
                  ];
                }
              }),
              _: 1
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-0ywA9zSm.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-B3_NbZ0Z.mjs'));
...
export { VListItemTitle as $, makeDimensionProps as A, makeComponentProps as B, useLayout as C, breakpoints as D, provideTheme as E, useBackgroundColor as F, useBorder as G, useElevation as H, useRounded as I, useResizeObserver as J, makeThemeProps as K, makeRoundedProps as L, makeElevationProps as M, makeBorderProps as N, convertToUnit as O, provideDefaults as P, VImg as Q, VDefaultsProvider as R, VExpandTransition as S, useLocale as T, wrapInArray as U, VApp as V, useUserStore as W, VCardTitle as X, VCardText as Y, VListItem as Z, _export_sfc as _, useNuxtApp as a, makeVOverlayProps as a$, VDialog as a0, VList as a1, VCardActions as a2, MaybeTransition as a3, makeTransitionProps$1 as a4, VSlideYTransition as a5, VLabel as a6, makeLoaderProps as a7, EventProp as a8, IconValue as a9, makeVariantProps as aA, deepEqual as aB, Ripple as aC, useVariant as aD, useDensity as aE, useSize as aF, useGroupItem as aG, useLink as aH, genOverlays as aI, makeSizeProps as aJ, makeRouterProps as aK, makeGroupItemProps as aL, makeDensityProps as aM, VListItemSubtitle as aN, VProgressLinear as aO, createRange as aP, keyValues as aQ, getCurrentInstance as aR, defineFunctionalComponent as aS, consoleError as aT, getObjectValueByPath as aU, isEmpty as aV, getPropertyFromItem as aW, useScopeId as aX, VMenuSymbol as aY, isClickInsideElement as aZ, omit as a_, makeFocusProps as aa, useLoader as ab, useFocus as ac, useInputIcon as ad, getUid as ae, useTextColor as af, nullifyTransforms as ag, animate as ah, standardEasing as ai, LoaderSlot as aj, VExpandXTransition as ak, isOn as al, pick as am, Intersect as an, forwardRefs as ao, makeVInputProps as ap, filterInputAttrs as aq, VInput as ar, callEvent as as, makeGroupProps as at, makeDisplayProps as au, useDisplay as av, useGroup as aw, useGoTo as ax, VFadeTransition as ay, focusableChildren as az, useRuntimeConfig as b, VListSubheader as b$, VDialogTransition as b0, focusChild as b1, VOverlay as b2, getNextElement as b3, debounce as b4, isObject as b5, useItems as b6, useForm as b7, makeItemsProps as b8, ensureValidVNode as b9, useLazy as bA, makeLazyProps as bB, useLocation as bC, usePosition as bD, makePositionProps as bE, makeLocationProps as bF, getDecimals as bG, VScaleTransition as bH, VProgressCircular as bI, useCookieStore as bJ, VCardSubtitle as bK, makeVImgProps as bL, createSimpleFunctional as bM, VResponsive as bN, VCardItem as bO, useRouter as bP, toPhysical as bQ, makeDelayProps as bR, useDelay as bS, useTheme as bT, humanReadableFileSize as bU, useRoute$1 as bV, noop as bW, makeSelectionControlGroupProps as bX, VSelectionControlGroup as bY, createLayout as bZ, makeLayoutProps as b_, checkPrintable as ba, matchesSelector as bb, makeVSelectionControlProps as bc, VSelectionControl as bd, defineComponent as be, getEventCoordinates as bf, HexToHSV as bg, HSVtoHex as bh, HSLtoHSV as bi, HSVtoHSL as bj, RGBtoHSV as bk, HSVtoRGB as bl, has as bm, SUPPORTS_EYE_DROPPER as bn, HSVtoCSS as bo, parseColor as bp, RGBtoCSS as bq, getContrast as br, consoleWarn as bs, VSwitch as bt, VBtnToggle as bu, VSnackbar as bv, makeVBtnProps as bw, createForm as bx, makeFormProps as by, keys as bz, nuxtLinkDefaults as c, pickWithRest as c0, useDate as c1, getWeek as c2, templateRef as c3, defineNuxtRouteMiddleware as c4, VListGroup as c5, __nuxt_component_0 as c6, resolveUnrefHeadInput as d, entry$1 as default, VSpacer as e, VBtn as f, VCard as g, VIcon as h, injectHead as i, VDivider as j, VAvatar as k, clamp as l, genericComponent as m, navigateTo as n, useProxiedModel as o, propsFactory as p, useToggleScope as q, resolveRouteObject as r, useSsrBoot as s, useLayoutItem as t, useRouter$1 as u, useRender as v, makeLayoutItemProps as w, useRtl as x, useDimension as y, makeTagProps as z };
