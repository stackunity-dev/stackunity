import { shallowRef, computed, unref, watchEffect, watch, provide, inject, ref, toRef, createVNode, mergeProps, nextTick, capitalize, Fragment, createTextVNode, withModifiers, toDisplayString, toRefs } from 'vue';
import { p as propsFactory, b0 as wrapInArray, bn as getPropertyFromItem, l as useProxiedModel, aY as getCurrentInstance, j as clamp, k as genericComponent, aI as useLocale, w as useRtl, D as provideTheme, a2 as useDisplay, O as provideDefaults, I as useResizeObserver, bB as createRange, s as useRender, e as VBtn, aK as makeVariantProps, K as makeThemeProps, y as makeTagProps, bj as makeSizeProps, L as makeRoundedProps, M as makeElevationProps, aN as makeDensityProps, A as makeComponentProps, N as makeBorderProps, ap as IconValue, bE as keyValues, bG as defineFunctionalComponent, J as convertToUnit, bH as consoleError, a$ as deepEqual, bI as getObjectValueByPath, bJ as isEmpty, ae as useLoader, E as useBackgroundColor, al as LoaderSlot, an as makeLoaderProps, a7 as makeDisplayProps, g as VIcon, ao as EventProp, bK as isOn, h as VDivider } from './server.mjs';
import { V as VSelect } from './VSelect.mjs';
import { V as VChip } from './VChip.mjs';
import { V as VCheckboxBtn } from './VCheckboxBtn.mjs';
import { V as VTable, m as makeVTableProps } from './VTable.mjs';
