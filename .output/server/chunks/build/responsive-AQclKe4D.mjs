...
import { _ as _export_sfc, W as useUserStore, V as VApp, g as VCard, bt as VSwitch, f as VBtn, Y as VCardText, h as VIcon, bu as VBtnToggle, e as VSpacer, bv as VSnackbar } from './server.mjs';
...
import { b as VChipGroup, V as VChip } from './VChip-BzNlhlnv.mjs';
  ...
  setup(__props) {
    ...
    const getDeviceDimensions = (deviceId) => {
      ...
      if (orientation.value === "landscape") {
        return `${device.height}\xD7${device.width}`;
      }
      return `${device.width}\xD7${device.height}`;
    };
...
//# sourceMappingURL=responsive-AQclKe4D.mjs.map
