import { toRefs, toRef, computed, createVNode, mergeProps, Fragment, ref, watchEffect, capitalize, provide, shallowRef, unref, watch, inject, createTextVNode, withModifiers, toDisplayString, nextTick } from 'vue';
import { m as genericComponent, p as propsFactory, P as provideDefaults, v as useRender, j as VDivider, o as useProxiedModel, T as useLocale, aR as getCurrentInstance, U as wrapInArray, aB as deepEqual, ab as useLoader, F as useBackgroundColor, av as useDisplay, aj as LoaderSlot, a9 as IconValue, aW as getPropertyFromItem, aU as getObjectValueByPath, aV as isEmpty, l as clamp, x as useRtl, E as provideTheme, J as useResizeObserver, aP as createRange, f as VBtn, a7 as makeLoaderProps, au as makeDisplayProps, aS as defineFunctionalComponent, h as VIcon, O as convertToUnit, al as isOn, aA as makeVariantProps, K as makeThemeProps, z as makeTagProps, aJ as makeSizeProps, L as makeRoundedProps, M as makeElevationProps, aM as makeDensityProps, B as makeComponentProps, N as makeBorderProps, aQ as keyValues, a8 as EventProp, aT as consoleError } from './server.mjs';
import { V as VSelect } from './VSelect-CnzUTO4G.mjs';
import { V as VChip } from './VChip-BzNlhlnv.mjs';
import { V as VCheckboxBtn } from './VCheckboxBtn-C031VWof.mjs';
import { V as VTable, m as makeVTableProps } from './VTable-B48xBhMG.mjs';
...
export { VDataTable as V, makeFilterProps as m, useFilter as u };
//# sourceMappingURL=VDataTable-BNKyhcJX.mjs.map
