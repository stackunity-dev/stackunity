...
import { _ as _imports_0 } from './virtual_public-CkarRP61.mjs';
import { useRouter } from 'vue-router';
import { _ as _export_sfc, W as useUserStore, h as VIcon, g as VCard, j as VDivider, f as VBtn, bI as VProgressCircular, bv as VSnackbar } from './server.mjs';
...
import { V as VSelect } from './VSelect-CnzUTO4G.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "auth-screen" }, _attrs))} data-v-757f78ba>`);
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(VCol, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="left-content text-center" data-v-757f78ba${_scopeId3}><h1 data-v-757f78ba${_scopeId3}><img${ssrRenderAttr("src", _imports_0)} alt="Devunity - Develop faster and better with DevUnity" class="logo mb-8" width="350" data-v-757f78ba${_scopeId3}><span class="sr-only" data-v-757f78ba${_scopeId3}>Devunity - Develop faster and better with DevUnity</span></h1><div class="features-list" data-v-757f78ba${_scopeId3}><!--[-->`);
                        ssrRenderList(features.value, (feature, index) => {
                          _push4(`<div class="${ssrRenderClass([{ "mb-6": index !== features.value.length - 1 }, "feature-item d-flex align-center"])}" data-v-757f78ba${_scopeId3}>`);
                          ...
                          _push4(`<div class="text-left" data-v-757f78ba${_scopeId3}><p class="text-body-1 font-weight-medium text-white mb-1" data-v-757f78ba${_scopeId3}>${ssrInterpolate(feature.title)}</p><p class="text-body-2 text-white-darken-2" data-v-757f78ba${_scopeId3}>${ssrInterpolate(feature.description)}</p></div></div>`);
                        });
                        _push4(`<!--]--></div></div>`);
                      } else {
                        return [
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(VCard, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="d-flex justify-center d-md-none mb-8" data-v-757f78ba${_scopeId4}><img${ssrRenderAttr("src", _imports_0)} alt="Devunity Logo" width="300" data-v-757f78ba${_scopeId4}></div><h2 class="text-h5 font-weight-bold mb-2" data-v-757f78ba${_scopeId4}>Premium Payment</h2><p class="text-subtitle-1 text-medium-emphasis mb-8" data-v-757f78ba${_scopeId4}>Lifetime access to all premium features</p><div class="mb-6 px-3 py-4 bg-surface-variant rounded-lg" data-v-757f78ba${_scopeId4}><div class="d-flex justify-space-between align-center mb-3" data-v-757f78ba${_scopeId4}><span class="text-subtitle-1 font-weight-medium" data-v-757f78ba${_scopeId4}>Lifetime Premium Access</span><span class="text-h6 font-weight-bold" data-v-757f78ba${_scopeId4}>${ssrInterpolate(taxDetails.value.baseAmount)}\u20AC</span></div>`);
                              _push5(ssrRenderComponent(VDivider, { class: "mb-3" }, null, _parent5, _scopeId4));
                              _push5(`<div class="d-flex justify-space-between align-center mb-1" data-v-757f78ba${_scopeId4}><span class="text-body-2 text-medium-emphasis" data-v-757f78ba${_scopeId4}>Subtotal</span><span class="text-body-2" data-v-757f78ba${_scopeId4}>${ssrInterpolate(taxDetails.value.baseAmount)}\u20AC</span></div><div class="d-flex justify-space-between align-center" data-v-757f78ba${_scopeId4}><span class="text-body-2 text-medium-emphasis" data-v-757f78ba${_scopeId4}>VAT (${ssrInterpolate(taxDetails.value.taxPercentage)}%)</span><span class="text-body-2" data-v-757f78ba${_scopeId4}>${ssrInterpolate(taxDetails.value.taxAmount)}\u20AC</span></div>`);
                              _push5(ssrRenderComponent(VDivider, { class: "my-3" }, null, _parent5, _scopeId4));
                              _push5(`<div class="d-flex justify-space-between align-center" data-v-757f78ba${_scopeId4}><span class="text-subtitle-1 font-weight-medium" data-v-757f78ba${_scopeId4}>Total</span><span class="text-h6 font-weight-bold" data-v-757f78ba${_scopeId4}>${ssrInterpolate(taxDetails.value.totalAmount)}\u20AC</span></div></div>`);
                              _push5(ssrRenderComponent(VForm, { onSubmit: processPayment }, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<div class="credit-card-container mb-6" data-v-757f78ba${_scopeId5}><div class="credit-card-wrapper" data-v-757f78ba${_scopeId5}><div class="credit-card-header d-flex justify-space-between align-center mb-4" data-v-757f78ba${_scopeId5}><div class="credit-card-chip" data-v-757f78ba${_scopeId5}></div><div class="d-flex" data-v-757f78ba${_scopeId5}><img src="https://cdn.jsdelivr.net/gh/aaronfagan/svg-credit-card-payment-icons/flat/visa.svg" class="credit-card-brand-icon" alt="Visa" data-v-757f78ba${_scopeId5}><img src="https://cdn.jsdelivr.net/gh/aaronfagan/svg-credit-card-payment-icons/flat/mastercard.svg" class="credit-card-brand-icon" alt="Mastercard" data-v-757f78ba${_scopeId5}><img src="https://cdn.jsdelivr.net/gh/aaronfagan/svg-credit-card-payment-icons/flat/amex.svg" class="credit-card-brand-icon" alt="American Express" data-v-757f78ba${_scopeId5}></div></div>`);
                                    ...
                                    _push6(`<div class="stripe-card-element mb-2" data-v-757f78ba${_scopeId5}></div>`);
                                    if (cardError.value) {
                                      _push6(`<div class="text-error mb-4 text-body-2" data-v-757f78ba${_scopeId5}>${ssrInterpolate(cardError.value)}</div>`);
                                    } else {
                                      _push6(`<!---->`);
                                    }
                                    _push6(`</div></div>`);
                                    ...
                                    _push6(`<div class="d-flex align-center justify-center mt-5" data-v-757f78ba${_scopeId5}>`);
                                    _push6(ssrRenderComponent(VIcon, {
                                      icon: "mdi-shield-check-outline",
                                      size: "small",
                                      class: "mr-2"
                                    }, null, _parent6, _scopeId5));
                                    _push6(`<span class="text-caption text-medium-emphasis" data-v-757f78ba${_scopeId5}>Secure payment via Stripe</span></div>`);
                                  } else {
                                    return [
...
const checkout = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-757f78ba"]]);

export { checkout as default };
//# sourceMappingURL=checkout-EWh16_Sz.mjs.map
