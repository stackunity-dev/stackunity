...
import { V as VTable } from './VTable.mjs';
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(VContainer, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="text-center" data-v-9ddc80c3${_scopeId3}><p class="text-body-2 text-medium-emphasis" data-v-9ddc80c3${_scopeId3}> © ${ssrInterpolate((/* @__PURE__ */ new Date()).getFullYear())} DevUnity. All rights reserved. </p></div>`);
                      } else {
                        return [
