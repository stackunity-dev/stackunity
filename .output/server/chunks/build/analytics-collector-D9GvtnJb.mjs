...
import { bJ as useCookieStore, W as useUserStore } from './server.mjs';
  ...
  setup(__props) {
    ...
    const getLocation = async () => {
      try {
        ...
        console.warn("Impossible de r\xE9cup\xE9rer la localisation:", error);
        return {
          country: "Unknown",
          city: "Unknown"
        };
    ...
    const startTracking = () => {
      ...
      console.log("D\xE9marrage du suivi analytique");
    ...
    const stopTracking = async () => {
      console.log("Arr\xEAt du suivi analytique");
    ...
    const sendPageView = async () => {
      ...
      try {
        ...
        console.error("Erreur lors de l'envoi des donn\xE9es analytiques:", error);
      }
    };
    const handleVisibilityChange = async () => {
      ...
      if ((void 0).hidden) {
        ...
        try {
          ...
          console.error("Erreur lors de l'envoi des donn\xE9es de fin de session:", error);
        }
      }
    };
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/analytics-collector.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as _ };
//# sourceMappingURL=analytics-collector-D9GvtnJb.mjs.map
