globalThis.__timing__.logStart('Load chunks/build/snippetsView-styles.CZAeh9Gz');const l=`pre code.hljs{display:block;overflow-x:auto;padding:1em}code.hljs{padding:3px 5px}/*!
  Theme: GitHub Dark
...
const snippetsViewStyles_CZAeh9Gz = [l];

export { snippetsViewStyles_CZAeh9Gz as default };;globalThis.__timing__.logEnd('Load chunks/build/snippetsView-styles.CZAeh9Gz');
