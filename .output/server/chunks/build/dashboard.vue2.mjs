          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(VNavigationDrawer, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="drawer-header pa-4" data-v-36af71aa${_scopeId2}><div class="d-flex align-center mb-4" data-v-36af71aa${_scopeId2}><div class="logo-container mr-3" data-v-36af71aa${_scopeId2}><img${ssrRenderAttr("src", _imports_0)} alt="DevUnity" class="logo-devunity" data-v-36af71aa${_scopeId2}></div><div data-v-36af71aa${_scopeId2}><div class="text-h6 font-weight-bold" data-v-36af71aa${_scopeId2}>DevUnity</div><div class="text-caption text-medium-emphasis" data-v-36af71aa${_scopeId2}>v1.0.0</div></div></div>`);
                              ...
                              ssrRenderList(recentSnippets.value, (snippet, index) => {
                                _push5(ssrRenderComponent(VListItem, {
                                  ...
                                  subtitle: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(`<span class="text-caption" data-v-36af71aa${_scopeId5}>${ssrInterpolate(getSnippetDate(snippet))}</span>`);
                                    } else {
                                      return [
                            ...
                            if (_push5) {
                              ...
                              ssrRenderList(recentSQLSchemas.value, (schema, index) => {
                                _push5(ssrRenderComponent(VListItem, {
                                  ...
                                  subtitle: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(`<span class="text-caption" data-v-36af71aa${_scopeId5}>${ssrInterpolate(getSchemaTablesCount(schema))} tables</span>`);
                                    } else {
                                      return [
            ...
            _push2(ssrRenderComponent(VAppBar, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<div class="d-flex align-center" data-v-36af71aa${_scopeId2}>`);
                  ...
                  _push3(`<div class="text-h5 font-weight-bold" data-v-36af71aa${_scopeId2}>${ssrInterpolate(currentPageTitle.value)}</div></div>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(VMain, { class: "pa-0" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="content-wrapper" data-v-36af71aa${_scopeId2}>`);
...
const dashboard = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-36af71aa"]]);
