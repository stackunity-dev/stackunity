...
import { defineComponent, ref, watch, computed, withCtx, unref, createVNode, toDisplayString, createBlock, createCommentVNode, openBlock, Fragment, renderList, mergeProps, createTextVNode, resolveDynamicComponent, markRaw, useSSRContext } from 'vue';
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(VNavigationDrawer, {
              modelValue: mobileDrawer.value,
              "onUpdate:modelValue": ($event) => mobileDrawer.value = $event,
              "mobile-breakpoint": 960,
              permanent: unref(display).mdAndUp.value,
              temporary: unref(display).smAndDown.value,
              location: "left",
              class: "dashboard-drawer"
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="drawer-header pa-4" data-v-5b142362${_scopeId2}><div class="d-flex align-center mb-4" data-v-5b142362${_scopeId2}><div class="logo-container mr-3" data-v-5b142362${_scopeId2}><img${ssrRenderAttr("src", _imports_0)} alt="DevUnity" class="logo-devunity" data-v-5b142362${_scopeId2}></div><div data-v-5b142362${_scopeId2}><div class="text-h6 font-weight-bold" data-v-5b142362${_scopeId2}>DevUnity</div><div class="text-caption text-medium-emphasis" data-v-5b142362${_scopeId2}>v1.0.0</div></div></div>`);
                              ...
                              ssrRenderList(recentSnippets.value, (snippet, index) => {
                                _push5(ssrRenderComponent(VListItem, {
                                  ...
                                  subtitle: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(`<span class="text-caption" data-v-5b142362${_scopeId5}>${ssrInterpolate(getSnippetDate(snippet))}</span>`);
                                    } else {
                                      return [
                            ...
                            if (_push5) {
                              ...
                              ssrRenderList(recentSQLSchemas.value, (schema, index) => {
                                _push5(ssrRenderComponent(VListItem, {
                                  ...
                                  subtitle: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(`<span class="text-caption" data-v-5b142362${_scopeId5}>${ssrInterpolate(getSchemaTablesCount(schema))} tables</span>`);
                                    } else {
                                      return [
            ...
            _push2(ssrRenderComponent(VNavigationDrawer, {
              modelValue: desktopDrawer.value,
              "onUpdate:modelValue": ($event) => desktopDrawer.value = $event,
              permanent: "",
            ...
            _push2(ssrRenderComponent(VAppBar, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (unref(display).smAndDown.value) {
                    _push3(ssrRenderComponent(VAppBarNavIcon, {
                      onClick: ($event) => mobileDrawer.value = !mobileDrawer.value,
                      color: "white"
                    }, null, _parent3, _scopeId2));
                  } else {
                    _push3(`<!---->`);
                  }
                  _push3(`<div class="d-flex align-center" data-v-5b142362${_scopeId2}>`);
                  _push3(ssrRenderComponent(VIcon, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`${ssrInterpolate(getCurrentPageIcon())}`);
                      } else {
                        return [
                  ...
                  _push3(`<div class="text-h5 font-weight-bold" data-v-5b142362${_scopeId2}>${ssrInterpolate(currentPageTitle.value)}</div></div>`);
                } else {
                  return [
                    unref(display).smAndDown.value ? (openBlock(), createBlock(VAppBarNavIcon, {
                      key: 0,
                      onClick: ($event) => mobileDrawer.value = !mobileDrawer.value,
                      color: "white"
            ...
            _push2(ssrRenderComponent(VMain, { class: "pa-0" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="content-wrapper" data-v-5b142362${_scopeId2}>`);
            ...
            return [
              ...
              createVNode(VNavigationDrawer, {
                ...
                _: 1
              }, 8, ["modelValue", "onUpdate:modelValue", "permanent", "temporary"]),
              createVNode(VNavigationDrawer, {
                modelValue: desktopDrawer.value,
                "onUpdate:modelValue": ($event) => desktopDrawer.value = $event,
                permanent: "",
...
const dashboard = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-5b142362"]]);
