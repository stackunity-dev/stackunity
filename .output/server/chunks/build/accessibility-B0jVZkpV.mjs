import { p as premiumFeatures } from './PremiumFeature-CXoy71CS.mjs';
import { defineComponent, ref, withCtx, createTextVNode, createVNode, withKeys, unref, createBlock, openBlock, toDisplayString, Fragment, renderList, createCommentVNode, toRef, computed, mergeProps, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrInterpolate, ssrRenderAttr, ssrRenderList, ssrRenderStyle } from 'vue/server-renderer';
import { W as useUserStore, V as VApp, g as VCard, X as VCardTitle, Y as VCardText, f as VBtn, m as genericComponent, h as VIcon, j as VDivider, p as propsFactory, F as useBackgroundColor, y as useDimension, H as useElevation, E as provideTheme, T as useLocale, U as wrapInArray, v as useRender, K as makeThemeProps, M as makeElevationProps, A as makeDimensionProps } from './server.mjs';
...
//# sourceMappingURL=accessibility-B0jVZkpV.mjs.map
