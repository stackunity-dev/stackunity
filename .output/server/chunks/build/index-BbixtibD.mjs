...
import { _ as _export_sfc, W as useUserStore, V as VApp, e as VSpacer, f as VBtn, h as VIcon, a1 as VList, Z as VListItem, $ as VListItemTitle, bN as VResponsive, Q as VImg, g as VCard, Y as VCardText, k as VAvatar, bO as VCardItem, X as VCardTitle, a2 as VCardActions, j as VDivider } from './server.mjs';
...
import { V as VNavigationDrawer } from './VNavigationDrawer-BpWtjP28.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const Pricing = defineAsyncComponent(() => import('./pricing-uujw4ONh.mjs'));
    const Faq = defineAsyncComponent(() => import('./faq-CaM9z8Rl.mjs'));
    const stats = [
                ...
                if (_push3) {
                            ...
                            if (_push5) {
                              _push5(ssrRenderComponent(VRow, { class: "footer-columns-container" }, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<!--[-->`);
                                    ssrRenderList(footerColumns, (column, index2) => {
                                    ...
                                    return [
                                      (openBlock(), createBlock(Fragment, null, renderList(footerColumns, (column, index2) => {
                                        return createVNode(VCol, {
                                          key: index2,
                                          cols: "6",
                                          md: "4",
                  ...
                  return [
                    ...
                    createVNode("div", { class: "d-flex flex-column flex-sm-row justify-space-between align-center" }, [
                      createVNode("div", { class: "text-body-2 text-medium-emphasis mb-3 mb-sm-0" }, " \xA9 " + toDisplayString((/* @__PURE__ */ new Date()).getFullYear()) + " DevUnity. All rights reserved. ", 1),
...
//# sourceMappingURL=index-BbixtibD.mjs.map
