  ...
  try {
    ...
    const analyzePage = async (pageUrl) => {
      ...
      result.coreWebVitals = {
        FCP: ((_b = paintEntries.find((entry) => entry.name === "first-contentful-paint")) == null ? void 0 : _b.startTime) || 0,
        LCP: (navEntry == null ? void 0 : navEntry.domContentLoadedEventEnd) || 0,
