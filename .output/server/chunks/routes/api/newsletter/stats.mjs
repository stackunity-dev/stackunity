globalThis.__timing__.logStart('Load chunks/routes/api/newsletter/stats');import { c as defineEventHandler, q as getRequestHeader, p as pool } from '../../../_/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:events';
import 'node:buffer';
