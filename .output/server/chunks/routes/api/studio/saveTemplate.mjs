globalThis.__timing__.logStart('Load chunks/routes/api/studio/saveTemplate');import { c as defineEventHandler, r as readBody, p as pool } from '../../../_/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:events';
import 'node:buffer';
...
export { saveTemplate as default };;globalThis.__timing__.logEnd('Load chunks/routes/api/studio/saveTemplate');
