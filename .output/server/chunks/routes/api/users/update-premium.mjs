globalThis.__timing__.logStart('Load chunks/routes/api/users/update-premium');import { c as defineEventHandler, q as getRequestHeader, r as readBody } from '../../../_/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:events';
import 'node:buffer';
