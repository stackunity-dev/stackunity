globalThis.__timing__.logStart('Load chunks/routes/api/analytics');import { c as defineEventHandler, r as readBody, p as pool, e as createError, g as getHeaders } from '../../_/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:events';
import 'node:buffer';
...
export { analytics as default };;globalThis.__timing__.logEnd('Load chunks/routes/api/analytics');
