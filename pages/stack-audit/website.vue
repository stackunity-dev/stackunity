                ...
                <v-row>
                                  ...
                                  <v-card-text>
                                    <v-list>
                                      <v-list-item>
                                        <template v-slot:prepend>
                                          <v-icon :color="mainTechnicalData?.sitemap?.found ? 'success' : 'error'">
                                            {{ mainTechnicalData?.sitemap?.found ? 'mdi-check-circle' :
                                              'mdi-alert-circle'
                                            }}
                                          </v-icon>
                                        </template>
                                        <v-list-item-title>
                                          {{ mainTechnicalData?.sitemap?.found ? t().buttons.found :
                                            t().buttons.notFound
                                          }}
                                        </v-list-item-title>
                                      ...
                                      <v-list-item v-if="mainTechnicalData?.sitemap?.issues?.length">
                                        ...
                                        <v-list-item-subtitle>
                                          <v-chip v-for="(issue, index) in mainTechnicalData.sitemap.issues"
                                            :key="index" :color="getIssueSeverityColor(issue.severity)" size="small"
                                            class="ma-1">
                                            {{ issue.message }}
                                          </v-chip>
                  ...
                  <v-col cols="12" v-if="websiteData?.generated_sitemap">
                    <v-card variant="outlined" class="mb-4">
                      ...
                      <v-card-text>
                        <pre ref="sitemapRef"
                          class="sitemap-content pa-4 bg-surface">{{ sitemapLines.join('\n') }}</pre>
                        <div v-if="remainingLines > 0" class="text-center mt-2">
                          <v-btn color="primary" variant="text" size="small"
                            @click="showFullSitemap = !showFullSitemap">
