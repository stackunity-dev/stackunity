...
useHead({
  ...
  meta: [
    ...
    { property: 'og:image', content: computed(() => `https://stackunity.tech/images/preview-stackunity.png`) },
    ...
    { property: 'og:image:secure_url', content: computed(() => `https://stackunity.tech/images/preview-stackunity.png`) },
    ...
    { name: 'twitter:image', content: computed(() => `https://stackunity.tech/images/preview-stackunity.png`) },
