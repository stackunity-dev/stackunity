  ...
  <v-app class="landing-screen">
      ...
      <v-container class="d-flex align-center py-0 my-0">
        <NuxtLink to="/login" class="text-decoration-none">
          <div class="d-flex align-center brand-container">
            <img src="/logo/devunity-title.png" alt="StackUnity title" width="150" class="logo-image">
    ...
    <v-navigation-drawer v-model="drawer" location="right" temporary
      ...
      <div class="drawer-footer mt-auto pt-6">
        ...
        <p class="text-caption text-center text-medium-emphasis">Join our community of developers and propulse your web
    ...
    <v-main class="main-content">
        ...
        <v-container class="py-16">
          <v-row class="align-center justify-center">
            ...
            <v-col cols="12" md="6" class="d-flex justify-center mt-8 mt-md-0">
              <v-img src="/images/preview-devunity.avif" max-width="90%" contain
                class="hero-image rounded-xl elevation-10" alt="Devroid Platform"></v-img>
            </v-col>
          </v-row>
        </v-container>
      </section>
      ...
      <section id="features" class="py-16">
        <v-container>
          <div class="text-center mb-12">
            ...
            <h2 class="text-h3 font-weight-bold mb-3">Features That Boost Your Productivity</h2>
      ...
      <section class="py-16">
        <v-container>
          <div class="text-center mb-12">
            <h2 class="text-h3 font-weight-bold mb-3">How It Works</h2>
            <p class="text-subtitle-1 text-medium-emphasis mx-auto" style="max-width: 700px">
          ...
          <div class="d-flex justify-center mt-12">
            <v-btn size="large" color="info" variant="tonal" class="px-8 rounded-pill" elevation="2" to="/signup" nuxt>
              Get Started Now
        ...
        <v-container>
          <v-row justify="center">
            <v-col cols="12" md="8" class="text-center">
              <h2 class="text-h3 font-weight-bold white--text mb-4">Ready to get started?</h2>
        ...
        <v-row>
          <v-col cols="12" md="5" lg="5" class="mb-6 mb-md-0">
            <div class="d-flex align-center mb-4">
              <img src="/logo/devunity-title.png" alt="DevUnity title" width="180">
            </div>
            ...
            <div class="newsletter-signup mb-6">
              <div class="d-flex">
                <v-text-field v-model="email" density="compact" placeholder="Your email address" variant="outlined"
                  hide-details class="mr-2" prepend-inner-icon="mdi-email-outline"></v-text-field>
                <v-btn color="info" variant="tonal" class="ml-n1" :loading="loading" @click="submitEmail">
                  Subscribe
                </v-btn>
              </div>
          ...
          <v-col cols="12" md="7" lg="7">
            <v-row class="footer-columns-container">
              <v-col v-for="(column, index) in footerColumns" :key="index" cols="6" md="4" class="footer-column px-4">
                <h4 class="text-subtitle-1 font-weight-bold mb-4">{{ column.title }}</h4>
