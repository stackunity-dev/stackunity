import { defineComponent, ref, withCtx, createTextVNode, toDisplayString, createVNode, createBlock, openBlock, Fragment, renderList, computed, watch, mergeProps, shallowRef, useSSRContext } from 'vue';
...
import { _ as _export_sfc, W as useUserStore, V as VApp, h as VIcon, e as VSpacer, f as VBtn, g as VCard, Y as VCardText, X as VCardTitle, a1 as VList, Z as VListItem, $ as VListItemTitle, a0 as VDialog, a2 as VCardActions, bv as VSnackbar, j as VDivider, be as defineComponent$1, bt as VSwitch, bu as VBtnToggle, p as propsFactory, o as useProxiedModel, bk as RGBtoHSV, bp as parseColor, bs as consoleWarn, x as useRtl, P as provideDefaults, v as useRender, bo as HSVtoCSS, a_ as omit, bg as HexToHSV, bh as HSVtoHex, bi as HSLtoHSV, bj as HSVtoHSL, bl as HSVtoRGB, bm as has, l as clamp, O as convertToUnit, J as useResizeObserver, bf as getEventCoordinates, bn as SUPPORTS_EYE_DROPPER, bq as RGBtoCSS, aB as deepEqual, br as getContrast, B as makeComponentProps } from './server.mjs';
...
import { V as VTabs, a as VTab } from './VTabs-aBFik-v8.mjs';
...
import { V as VWindow, a as VWindowItem } from './VWindowItem-CdIf3hsK.mjs';
import { V as VTextarea } from './VTextarea-Bo6BF8Al.mjs';
import { V as VSlider } from './VSlider-DE6qm1WR.mjs';
import { V as VSheet, m as makeVSheetProps } from './VSheet-ZV3ewAyn.mjs';
import { a as VToolbarTitle, V as VToolbar } from './VToolbar-Cwh-hMsA.mjs';
...
import { V as VDataTable } from './VDataTable-BNKyhcJX.mjs';
...
<body>
  <div class="container">
    ...
    <div class="footer">
      <p>\xA9 ${(/* @__PURE__ */ new Date()).getFullYear()} ${template.companyName}. All rights reserved.</p>
...
\xA9 ${(/* @__PURE__ */ new Date()).getFullYear()} ${template.companyName}. All rights reserved.
    ...
    const sendEmail = async () => {
      try {
        ...
        if (response) {
          ...
          console.log("R\xE9ponse du serveur:", result);
          if (result.success) {
            showSnackbar("Email envoy\xE9 avec succ\xE8s", "success");
          } else {
        ...
        console.error("Erreur d\xE9taill\xE9e lors de l'envoi:", error);
                                        ...
                                        createVNode("div", {
                                          ...
                                          createVNode("div", {
                                            ...
                                            createVNode("div", {
                                              ...
                                              createVNode("p", null, "\xA9 " + toDisplayString((/* @__PURE__ */ new Date()).getFullYear()) + " " + toDisplayString(emailData.value.companyName) + ". All rights reserved.", 1),
  ...
  setup(__props) {
    ...
    const loadStats = async () => {
      try {
        ...
        if (data.stats && data.stats.length > 0) {
          ...
          console.log("Newsletters charg\xE9es:", newsletters.value);
          console.log("Newsletter actuelle:", newsletter.value);
        } else {
          console.warn("Aucune newsletter trouv\xE9e dans les donn\xE9es");
        }
      } catch (error) {
    ...
    const createNewsletter = async () => {
      try {
        ...
        loadStats();
        showSnackbar("Newsletter cr\xE9\xE9 avec succ\xE8s", "success");
        addNewsletter.value = false;
      } catch (error) {
        console.error("Erreur lors de la cr\xE9ation de la newsletter:", error);
        showSnackbar("Erreur lors de la cr\xE9ation de la newsletter", "error");
      }
    };
...
//# sourceMappingURL=newsletter-admin-FPNMxKeb.mjs.map
