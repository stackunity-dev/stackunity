import { t as typescriptDefaults, m as monaco_editor_core_star } from './monaco-editor-vue3-CCyoAfhP.mjs';
  ...
  constructor(_libFiles, _defaults, _selector, worker) {
    ...
    const onModelAdd = (model) => {
      ...
      const changeSubscription = model.onDidChangeContent(() => {
        clearTimeout(handle);
        handle = (void 0).setTimeout(maybeValidate, 500);
      });
...
//# sourceMappingURL=tsMode-lIyswNO1.mjs.map
