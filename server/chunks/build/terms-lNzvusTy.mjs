...
import { _ as _export_sfc, g as VCard } from './server.mjs';
import '../_/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:fs';
          ...
          if (_push2) {
            ...
            return [
              ...
              createVNode("div", { class: "text-center" }, [
                ...
                createVNode("p", { class: "text-caption text-medium-emphasis" }, " \xA9 " + toDisplayString((/* @__PURE__ */ new Date()).getFullYear()) + " DevUnity. All rights reserved. ", 1)
              ])
            ];
          }
        }),
...
//# sourceMappingURL=terms-lNzvusTy.mjs.map
