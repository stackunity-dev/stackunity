...
import { _ as _export_sfc, V as VApp, e as VSpacer, f as VBtn, g as VCard, h as VIcon, j as VDivider, k as VAvatar } from './server.mjs';
                                          ...
                                          return [
                                            createVNode("section", { class: "mb-12" }, [
                                              ...
                                              createVNode("div", { class: "quote-block my-8 pa-8 rounded-lg" }, [
                                                ...
                                                createVNode("p", { class: "text-subtitle-1 font-weight-bold" }, "\u2014 N\xFBr Djedidi, Founder")
                                              ])
                                            ]),
                      ...
                      if (_push4) {
                        ...
                        return [
                          createVNode("div", { class: "d-flex flex-column flex-md-row justify-space-between align-center" }, [
                            ...
                            createVNode("div", { class: "text-body-2 text-medium-emphasis" }, " \xA9 " + toDisplayString((/* @__PURE__ */ new Date()).getFullYear()) + " DevUnity. All rights reserved. ", 1)
                          ])
                        ];
                      }
                    }),
...
//# sourceMappingURL=about-BUpf9lnP.mjs.map
