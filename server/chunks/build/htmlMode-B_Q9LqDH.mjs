import { m as monaco_editor_core_star } from './monaco-editor-vue3-CCyoAfhP.mjs';
...
var WorkerManager = class {
  constructor(defaults) {
    ...
    this._worker = null;
    this._client = null;
    this._idleCheckInterval = (void 0).setInterval(() => this._checkIfIdle(), 30 * 1e3);
  ...
  constructor(_languageId, _worker, configChangeEvent) {
    ...
    const onModelAdd = (model) => {
      ...
      this._listener[model.uri.toString()] = model.onDidChangeContent(() => {
        (void 0).clearTimeout(handle);
        handle = (void 0).setTimeout(() => this._doValidate(model.uri, modeId), 500);
      });
...
//# sourceMappingURL=htmlMode-B_Q9LqDH.mjs.map
