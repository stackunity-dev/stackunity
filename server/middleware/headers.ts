...
export default defineEventHandler((event) => {
  ...
  let cspValue = "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://plausible.io; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com; img-src * 'self' data: blob:; connect-src 'self' https://plausible.io; worker-src 'self'; frame-ancestors 'none'";
